...
| 030c | Self-host Google Fonts (Inter + Space Grotesk) | ✅ Cerrada (2026-05-10) | Post-SPEC-030b Performance 84: Google Fonts external sumaba ~610ms al LCP por DNS+TLS+CSS+WOFF2 chain; el LCP element es el texto del hero que repintaba al llegar la web font | [SPEC-030c](specs/SPEC-030c-self-host-fonts.md) |
